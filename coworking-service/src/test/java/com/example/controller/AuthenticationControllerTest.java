...
public class AuthenticationControllerTest {
    ...
    void testAuthentification_ValidToken() throws Exception {
        ...
        User reqUser = new User("user0001", "user0001");
    ...
    void tesRegistration_ValidToken() throws Exception {
        ...
        User reqUser = new User("user0001", "user0001");
        String token = "token";
        when(userMapper.DtoToModel(any(UserDTO.class))).thenReturn(reqUser);
        when(service.registration(reqUser)).thenReturn(token);
